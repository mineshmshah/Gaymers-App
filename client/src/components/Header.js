...
class Header extends Component{
	renderContent() {
		...
		case null:
			return;
		case false:
			return <a className="f6 dib white bg-animate hover-bg-white hover-black no-underline pv2 ph4 br-pill ba b--white-20" href="/auth/facebook">Sign In With Facebook</a>;
		default:
			//console.log(this.props.auth.newuser);
			return <a className="f6 link dib white dim mr3 mr4-ns" href="/api/logout">Logout</a>;
		}
	}
	...
	render(){
		...
		return(
			<div className="w-100 sans-serif bg-near-black">
