...
https://api-2445582011268.apicast.io/games/?search=overwatch&fields=name,category,genres,game_modes,cover,first_release_date
...
CREATE TABLE games (
    ...
    cover VARCHAR(8000) NOT NULL BOOLEAN DEFAULT 'false' NOT NULL,
    first_release_date INT UNIQUE NOT NULL
);
...
INSERT INTO games (name, category, genres, games_modes, cover, first_release_date) VALUES ("Overwatch", 0, [2], [5,12,15], 1464048000000, {
